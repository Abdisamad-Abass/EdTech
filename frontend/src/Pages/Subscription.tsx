    ...
    <div className='bg-linear-to-tl from-[#89BAFA] via-[#5A94DE] to-[#2C6DC2] md:mx-28 mt-28 md:rounded-4xl flex items-center justify-center'>
        <div className='py-20'>
            ...
            <div className='relative'>
                <input type="text" placeholder='Enter your email' className='w-[635] h-[81] mt-7 pl-10 text-xl font-semibold text-[#00000094] leading-5 bg-white rounded-[40px]'/>
                <button className=' btn-signin bg-gradient-to-b from-[#0F1A4F] to-[#0F1A4F] px-20 absolute right-0 top-7 h-[81]'>Send</button>
            </div>    
        </div>
    </div>
  )
