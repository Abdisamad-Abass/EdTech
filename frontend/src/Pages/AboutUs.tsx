...
const AboutUs = () => {
  ...
  return (
    <div className='bg-[#FFFFE2] flex md:flex-row flex-col px-20 md:px-28 mt-20'>
      {/* ---col-1 ---*/}
      <div>
        <img src={assets.study_group.src} alt="Study group" className=" md:w-[1400px] md:h-[500px]" />
      </div>
      ...
      <div className='relative py-20 md:ml-20'>
        ...
        <img src={assets.about_anim.src} alt="" className='absolute md:top-72 top-99 right-0 md:right-5 w-[92px] h-[273px]'/>
      </div>
